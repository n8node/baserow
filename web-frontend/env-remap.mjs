...
const envMapping = {
  ...
  YANDEX_METRIKA_ID: 'NUXT_PUBLIC_YANDEX_METRIKA_ID',
  ...
  BASEROW_NOTIFICATIONS_UI_VISIBLE:
    'NUXT_PUBLIC_BASEROW_NOTIFICATIONS_UI_VISIBLE',
  BASEROW_ENTERPRISE_FORK_UNLICENSED:
    'NUXT_PUBLIC_BASEROW_ENTERPRISE_FORK_UNLICENSED',
  BASEROW_ENTERPRISE_SSO_AUDIT_LOG_UNLICENSED:
    'NUXT_PUBLIC_BASEROW_ENTERPRISE_SSO_AUDIT_LOG_UNLICENSED',
