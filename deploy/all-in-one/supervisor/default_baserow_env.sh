...
# Use 127.0.0.1 (not localhost) so Caddy and other clients do not hit ::1 while
# Gunicorn/Nuxt bind to BASEROW_*_BIND_ADDRESS (127.0.0.1 only).
export PRIVATE_BACKEND_URL="${PRIVATE_BACKEND_URL:-http://127.0.0.1:8000}"
export PRIVATE_WEB_FRONTEND_URL="${PRIVATE_WEB_FRONTEND_URL:-http://127.0.0.1:3000}"
