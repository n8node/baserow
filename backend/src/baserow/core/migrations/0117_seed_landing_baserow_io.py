...
def seed(apps, schema_editor):
    ...
    ru_blocks = [
        ...
        dict(
            ...
            subtitle="Познакомьтесь с George AI — вашим AI-ассистентом. Опишите данные, которыми хотите управлять, и George AI построит всё сам.",
            body="",
            image_url="",
            primary_cta_label="Узнать о George AI",
            primary_cta_url="#",
            secondary_cta_label="",
            secondary_cta_url="",
            extra_data=_items({}),
    ...
    en_blocks = [
        ...
        dict(
            ...
            subtitle="Meet George AI, your AI assistant. Describe which data you need to manage and let George AI build it for you.",
            body="",
            image_url="",
            primary_cta_label="Learn about George AI",
            primary_cta_url="#",
            secondary_cta_label="",
            secondary_cta_url="",
            extra_data=_items({}),
